    ...
    return new Promise(function (resolve, reject) {
        ...
        if (obj.onProgressFunction) {
            ...
            xhr.onprogress = function () {
                obj.onProgressFunction(xhr); // call .apply(args...) with arguments
            };
        } else if (obj.onLoadStartFunction) {
            xhr.onloadstart = function () {
                obj.onLoadStartFunction(xhr); // call .apply(args...) with arguments
            };
        } else if (obj.onLoadEndFunction) {
            xhr.onloadend = function () {
                obj.onLoadEndFunction(xhr); // call .apply(args...) with arguments
            };
        }
        // Send request
        xhr.send(obj.body);
...
var _appDev = __webpack_require__(/*! ../scss/app-dev.scss */ "./src/scss/app-dev.scss");

var _appDev2 = _interopRequireDefault(_appDev);
...
exports.default = function () {
    // ------------------- Home page -------------------
    var element = document.getElementById('st-trick-list');
    if (element !== undefined && element !== null) {
        // Get defined parameters from server side
        var locale = element.querySelector('.uk-grid').getAttribute('data-locale');
        var loadingMode = element.querySelector('.uk-grid').getAttribute('data-loading-mode');
        var definedLimit = parseInt(element.querySelector('.uk-grid').getAttribute('data-limit'), 10);
        var nodes = element.querySelectorAll('.uk-card');
        var countAll = parseInt(element.querySelector('.uk-grid').getAttribute('data-count'), 10);
        var last = nodes[nodes.length - 1];
        var lastOffset = parseInt(last.parentElement.getAttribute('data-offset'), 10);
        var limit = parseInt(element.querySelector('.uk-grid').getAttribute('data-limit'), 10);
        var ajaxPrevented = false;
        var loadMoreButton = document.getElementById('st-home-load-more');

        // Prevent AJAX request from being called if all cards are already loaded.
        if (loadingMode === 'DESC' && lastOffset === 0 || loadingMode === 'ASC' && lastOffset === countAll - 1) {
            ajaxPrevented = true;
        } else {
        ...
        var toHomeListButton = document.getElementById('st-home-list-anchor');
        toHomeListButton.addEventListener('mouseover', function () {
            if (toHomeListButton !== undefined && toHomeListButton !== null) {
        ...
        toHomeListButton.addEventListener('mouseout', function () {
            if (toHomeListButton !== undefined && toHomeListButton !== null) {
        ...
        var toTopButton = document.getElementById('st-home-top');
        var toTop = function toTop() {
            nodes = element.querySelectorAll('.uk-card');
            if (toTopButton !== undefined && toTopButton !== null) {
        ...
        if (loadMoreButton !== undefined && loadMoreButton !== null) {
            loadMoreButton.addEventListener('click', function () {
                ...
                var endOffset = parseInt(last.parentElement.getAttribute('data-offset'), 10);
                var minOffset = 0;
                var maxOffset = countAll - 1;
                // check loading mode
                var startOffset = loadingMode === 'DESC' ? endOffset - limit : endOffset + 1;
                var validOffset = startOffset >= -limit && startOffset < maxOffset + limit + 1;
                var validLimit = limit >= 1;
                var validOrder = loadingMode === 'DESC' || loadingMode === 'ASC';
                ...
                if (!ajaxPrevented) {
                    var obj = {
                        url: limit !== definedLimit ? '/' + locale + '/home-load-tricks/' + startOffset + '/' + limit : '/' + locale + '/home-load-tricks/' + startOffset,
                        responseType: 'document',
                        onLoadStartFunction: function onLoadStartFunction() {
                            // Disable button
                    ...
                    (0, _ajaxRequest2.default)(obj).then(function (response) {
                        var tmp = document.createElement("div");
                        tmp.innerHTML = response;
                        var cards = tmp.querySelectorAll('.st-card-container');
                        var listError = false;
                            ...
                            var to = setTimeout(function () {
                                ...
                                if (index === cards.length - 1) {
                                    ...
                                    if (!listError && endReached) {
                                        _uikit2.default.notification({
                                            message: '<div class="uk-text-center uk-text-bold">\n                                                     <span uk-icon=\'icon: bell\'></span>&nbsp;No more trick to load!</div>',
                                            status: 'info',
                                            pos: 'top-center',
                                            timeout: 5000
                                        });
...
var _ajaxRequest = __webpack_require__(/*! ./ajax-request */ "./src/js/ajax-request.js");

var _ajaxRequest2 = _interopRequireDefault(_ajaxRequest);

var _uikit = __webpack_require__(/*! ../../uikit/dist/js/uikit.js */ "./uikit/dist/js/uikit.js");
...
/***/ 0:
/*!************************************************!*\
  !*** multi babel-polyfill ./src/js/app-dev.js ***!
  \************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

__webpack_require__(/*! babel-polyfill */"./node_modules/babel-polyfill/lib/index.js");
module.exports = __webpack_require__(/*! ./src/js/app-dev.js */"./src/js/app-dev.js");
