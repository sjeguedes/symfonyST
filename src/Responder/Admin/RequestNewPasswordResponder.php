...
/**
 * Class RequestNewPasswordResponder.
 *
 * Manage a response with html template to show a password renewal request form, its details and functionality.
 */
final class RequestNewPasswordResponder
{
    /**
