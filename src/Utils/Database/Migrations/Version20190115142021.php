...
final class Version20190115142021 extends AbstractMigration
{
    ...
    {
        $this->addSql("CREATE TABLE media_types (uuid BINARY(16) NOT NULL COMMENT '(DC2Type:uuid_binary)', type VARCHAR(255) NOT NULL, name VARCHAR(255) NOT NULL, description VARCHAR(255) NOT NULL, width INT NOT NULL, height INT NOT NULL, creation_date DATETIME NOT NULL, update_date DATETIME NOT NULL, UNIQUE INDEX UNIQ_46294D818CDE5729 (type), UNIQUE INDEX UNIQ_46294D815E237E06 (name), PRIMARY KEY(uuid)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB");
    }
    /**
