...
{
    /**
     * Create "medias" table and add constraints with "media_types", "images", "videos" and "tricks" tables.
     *
     * @param Schema $schema
     *
     * @return void
