 ...
 *
 * @see https://github.com/beberlei/DoctrineExtensions/blob/master/src/Query/Mysql/Field.php
 *
 ...
 * @see FIELD() cannot be uses directly in query builder orderBy() method due to Doctrine ORM parser in
